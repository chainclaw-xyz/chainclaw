...
export const configSchema = z.object({
  ...
  polygonRpcUrl: z.string().url().default("https://polygon-rpc.com"),
  bscRpcUrl: z.string().url().default("https://bsc-dataseed1.bnbchain.org"),
  avalancheRpcUrl: z.string().url().default("https://api.avax.network/ext/bc/C/rpc"),
  zkSyncRpcUrl: z.string().url().default("https://mainnet.era.zksync.io"),
  scrollRpcUrl: z.string().url().default("https://rpc.scroll.io"),
  blastRpcUrl: z.string().url().default("https://rpc.blast.io"),
  gnosisRpcUrl: z.string().url().default("https://rpc.gnosischain.com"),
  lineaRpcUrl: z.string().url().default("https://rpc.linea.build"),
  fantomRpcUrl: z.string().url().default("https://rpc.ftm.tools"),
  mantleRpcUrl: z.string().url().default("https://rpc.mantle.xyz"),
...
export function loadConfig(): Config {
  ...
  const result = configSchema.safeParse({
    ...
    bscRpcUrl: process.env.BSC_RPC_URL || "https://bsc-dataseed1.bnbchain.org",
    avalancheRpcUrl: process.env.AVALANCHE_RPC_URL || "https://api.avax.network/ext/bc/C/rpc",
    zkSyncRpcUrl: process.env.ZKSYNC_RPC_URL || "https://mainnet.era.zksync.io",
    scrollRpcUrl: process.env.SCROLL_RPC_URL || "https://rpc.scroll.io",
    blastRpcUrl: process.env.BLAST_RPC_URL || "https://rpc.blast.io",
    gnosisRpcUrl: process.env.GNOSIS_RPC_URL || "https://rpc.gnosischain.com",
    lineaRpcUrl: process.env.LINEA_RPC_URL || "https://rpc.linea.build",
    fantomRpcUrl: process.env.FANTOM_RPC_URL || "https://rpc.ftm.tools",
    mantleRpcUrl: process.env.MANTLE_RPC_URL || "https://rpc.mantle.xyz",
